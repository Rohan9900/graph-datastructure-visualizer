    ...
    if (!vis[node]) {
      ...
      for (let i = 0; i < neighborCount; i++) {
        ...
        if (!connections[`${node}-${neighbor}`] && !connections[`${neighbor}-${node}`]) {
          ...
          const startX = startNodeX + startNodeRadius / nodeRadius * (endNodeX - startNodeX);
          const startY = startNodeY + startNodeRadius / nodeRadius * (endNodeY - startNodeY);
          const endX = endNodeX - endNodeRadius / nodeRadius * (endNodeX - startNodeX);
          const endY = endNodeY - endNodeRadius / nodeRadius * (endNodeY - startNodeY);
...
//# sourceMappingURL=Graph-stories.3116039f3ed942ae9a88.hot-update.js.map