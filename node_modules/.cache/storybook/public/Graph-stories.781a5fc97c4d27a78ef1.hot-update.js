  ...
  const recurseGraph = (vis, node, x, y, ctx, pos, connections, canvas) => {
    if (!vis[node]) {
      ...
      for (let i = 0; i < neighborCount; i++) {
        ...
        console.log("yes1", newY, ctx.canvas.height);
        if (newY >= ctx.canvas.height / 2) {
          canvas.height = ctx.canvas.height + 200;
          console.log("yes");
        }
...
//# sourceMappingURL=Graph-stories.781a5fc97c4d27a78ef1.hot-update.js.map