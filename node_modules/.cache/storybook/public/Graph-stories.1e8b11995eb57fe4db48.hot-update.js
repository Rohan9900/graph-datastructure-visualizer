    ...
    if (!vis[node]) {
      ...
      for (let i = 0; i < neighborCount; i++) {
        ...
        if (!connections[`${node}-${neighbor}`] && !connections[`${neighbor}-${node}`]) {
          ...
          ctx.lineTo(pos[neighbor] ? pos[neighbor].x - nodeWidth / 2 + 2 : newX, pos[neighbor] ? pos[neighbor].y : newY);
          ctx.stroke();
...
//# sourceMappingURL=Graph-stories.1e8b11995eb57fe4db48.hot-update.js.map