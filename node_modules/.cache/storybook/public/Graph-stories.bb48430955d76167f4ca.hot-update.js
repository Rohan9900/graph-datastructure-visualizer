...
function GraphVisualizer({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    let connections = {};
    let visited = {};
    recurseGraph(visited, startingPoint, mainWidth / 2, 100, ctx, pos, connections, canvas);
  }, [isChange]);
  const adjustPosition = (x, y, nodeRadius) => {
    const padding = 10; // Padding around nodes
    const minX = nodeRadius + padding;
    const maxX = mainWidth - nodeRadius - padding;
    const minY = nodeRadius + padding;
    const maxY = mainHeight - nodeRadius - padding;
...
//# sourceMappingURL=Graph-stories.bb48430955d76167f4ca.hot-update.js.map