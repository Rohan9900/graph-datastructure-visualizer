    ...
    if (!vis[node]) {
      ...
      for (let i = 0; i < neighborCount; i++) {
        ...
        if (!connections[`${node}-${neighbor}`] && !connections[`${neighbor}-${node}`]) {
          ...
          ctx.lineTo(pos[neighbor] ? pos[neighbor].x - nodeWidth / 2 + 1 : newX, pos[neighbor] ? pos[neighbor].y : newY);
          ctx.stroke();
...
//# sourceMappingURL=Graph-stories.7b1ab69380f67463ab9a.hot-update.js.map